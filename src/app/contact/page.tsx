...
const schema = yup.object().shape({
  ...
  message: yup.string().min(10, 'A mensagem deve ter no mínimo 10 caracteres.').required('A mensagem é obrigatória.'),
});
...
const ContactPage: React.FC = () => {
  ...
  const onSubmit: SubmitHandler<FormData> = async (data) => {
    try {
      console.log(data); // Aqui você pode enviar os dados para sua API
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-gray-50">
      <h1 className="text-3xl font-bold text-gray-800 mb-4 text-center">Entre em Contato</h1>
      <p className="text-gray-600 mb-8 text-center max-w-2xl">
        Preencha o formulário abaixo ou use as informações de contato para falar diretamente conosco. 
        Estamos prontos para ajudar sua empresa a crescer com transformação digital.
      </p>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-gray-600">contato@bhsolutions.com</p>
            </div>
            <div>
